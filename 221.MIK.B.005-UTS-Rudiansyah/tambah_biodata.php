                  ...
                  <div class="card-content" style="margin-bottom: 1px;">
                    <div class="row">
                     ...
                     <div class="row" style="margin-bottom: 45px;">
                        <div class="col s12">
                           ...
                           <select class="browser-default" name="jurusan" id="jurusan">
                              ...
                              <?php $jurusan = array('Manajemen Informatika Dan komputer', 'IT Suport', 'Administrasi Perkantoran', 'Akuntasi Perkantoran',); ?>
                     ...
                     <div class="row">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                           <input placeholder="Masukkan Nomor Handphone" id="no_hp" type="text" class="validate" name="no_hp">
                           <label for="no_hp">Nomor Handphone</label>
                        </div>
                     </div>
                     <div class="row">
                        <div class="input-field col s12">
                           <input placeholder="Masukkan Nomor Handphone Orang Tua" id="no_hp_ortu" type="text" class="validate" name="no_hp_ortu">
